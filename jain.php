...
<body>
    ...
    <main>
        ...
        <section class="home-cooked">
            ...
            <div class="plan-grid">
                ...
                FROM `plan` p
                JOIN `users` u ON p.user_id = u.Id
                WHERE p.category = 'jain' AND u.ServiceType = 'Individual'";
                ...
                ?>
                    <div class="plan-card" onclick="fetchPlan('<?php echo $row['code'] ?>')">
                        <img src="<?php echo $row['url'] ?>" alt="jain plan">
        ...
        <section class="restaurant-cooked">
            ...
            <div class="restau-grid">
                ...
                FROM `plan` p
                JOIN `users` u ON p.user_id = u.Id
                WHERE p.category = 'jain' AND u.ServiceType = 'Business'";
    ...
    <footer>
        <p>Experience the joy of authentic jain cooking delivered straight to your door.</p>
    ...
    <script>
        ...
        function purchasePlan() {
            ...
            if (!loggedIn) {
                ...
                // Add purchase logic here if necessary
